...
This portfolio is intended for public release and contains only information that I am authorised to disclose. It does not intentionally include classified, confidential, proprietary, export-controlled, or otherwise restricted information. All material is presented subject to applicable confidentiality, contractual, security, and disclosure obligations.

## Introduction

I am Sylvester Kaczmarek, working at the crossroads of safe and secure AI, autonomous systems, robotics, space technologies, and critical infrastructure. My work focuses on making advanced intelligent systems reliable, resilient, interpretable, and secure, from adaptive AI and runtime assurance to spacecraft autonomy and cybersecurity, helping ensure that the technologies of tomorrow are built to be trusted today.
...
* [Professional Case Studies](/resources/projects.md)
* [License](#license)
* [Contact](#contact)

## Statement

In an era where AI systems are becoming more capable, robots are becoming our co-workers, and space remains a rapidly expanding frontier, my mission is not only to protect emerging technologies, but to help shape how they are built. I work across AI safety and alignment, cybersecurity, autonomy, robotics, and space systems, with a focus on developing technologies that remain secure, resilient, trustworthy, and dependable as their capabilities grow. I am committed to making sure that as we push the boundaries of what's technologically possible, we remain grounded in what's technologically secure.

## Professional Overview & Contributions

For a broader overview of my work, research, education, publications, and professional background, please visit:
...
<p align="center">
  <img src="/assets/images/room-space-journal-autumn-2025-cover-sylvester-kaczmarek.jpeg" alt="ROOM Space Journal Cover - Autumn 2025" width="600">
</p>

### Academic Roles

I serve as a professor of Cryptography and Secure Communications, Secure Software Development, Secure Large Language Models, and Parallel and Distributed Computing for both the MSc in Enterprise Cybersecurity and BSc in Modern Computer Science programs in Italy, and as an associate professor of Systems Engineering, Cybersecurity, and AI/ML for Space Systems & Infrastructure in Florida, US.
...
Beyond the cybersecurity certifications listed above, my background includes specialized credentials and extensive experience across related fields, including advanced AI and autonomous systems. This expertise has been developed through formal training, research, and practical work with globally recognized organizations and institutions. A comprehensive list of my training, certifications, and achievements is available upon request for qualified inquiries.

## Technical Skills & Expertise

Explore a detailed overview of my technical skills and experience across AI/ML, cybersecurity, secure communications, space systems, robotics, embedded systems, cloud technologies, programming, and risk and assurance on the [Technical Skills & Expertise page](/resources/skills.md).

## Professional Case Studies

Explore selected anonymised professional case studies spanning autonomous systems, robotics, cybersecurity, satellite communications, UAVs, critical infrastructure, and space technologies on the [Professional Case Studies page](/resources/projects.md).

## License

© Sylvester Kaczmarek. All rights reserved.

Unless otherwise stated, the contents of this portfolio may not be copied, modified, distributed, reproduced, republished, or used to create derivative works without prior written permission, except where permitted by applicable law or GitHub's Terms of Service. See the [LICENSE](/LICENSE) file for details.
